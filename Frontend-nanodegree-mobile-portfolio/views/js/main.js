...
var resizePizzas = function(size) {
 ...
 var newwidth = [];
     // This process saves the pizza form
    for (var i = 0; i < pizzaLength ; i++) {
      var dx = determineDx(pizzaContain[i], size);
      newwidth[i] = (pizzaContain[i].offsetWidth + dx) + 'px';
    }
   
    //This loop takes out the shape of the pizza
    for ( i = 0; i < pizzaLength ; i++) {
    pizzaContain[i].style.width = newwidth[i];
  }
  //This loop takes out the shape of the pizza
}
...
// this variable  create out the loop 
